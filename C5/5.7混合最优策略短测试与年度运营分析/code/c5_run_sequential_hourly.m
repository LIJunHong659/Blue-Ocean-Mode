...
for t=1:N
    ...
    bessChargeMWh=sum(d.pBessChargeMW)*cfg.time.dispatchStepH;
    bessDischargeMWh=sum(d.pBessDischargeMW)*cfg.time.dispatchStepH;
    bessThroughputMWh=bessChargeMWh+bessDischargeMWh;
    proxyProjectGHGKgCO2e = ...
        cfg.environment.sourceLifecycleKgCO2ePerMWhUsed*k.eSourceUsedMWh+ ...
        cfg.environment.bessThroughputKgCO2ePerMWh*bessThroughputMWh;
    proxyAvoidedGHGKgCO2e = ...
    ...
    proxyNetGHGKgCO2e=proxyProjectGHGKgCO2e-proxyAvoidedGHGKgCO2e;
    resultRows{t}=table(base.timeH(t),eventCode(t), ...
        ...
        bessChargeMWh,bessDischargeMWh,bessThroughputMWh, ...
        k.projectGHGKgCO2e,k.avoidedBaselineGHGKgCO2e, ...
        k.netGHGKgCO2e,proxyProjectGHGKgCO2e, ...
        proxyAvoidedGHGKgCO2e,proxyNetGHGKgCO2e, ...
        ...
        'bessChargeMWh','bessDischargeMWh','bessThroughputMWh', ...
        'projectGHGKgCO2e','avoidedBaselineGHGKgCO2e', ...
        'netGHGKgCO2e','proxyProjectGHGKgCO2e', ...
        'proxyAvoidedGHGKgCO2e','proxyNetGHGKgCO2e', ...
...
summary=table(string(strategy.id),string(strategy.strategyClass),N, ...
    ...
    sum(hourlyLedger.bessChargeMWh),sum(hourlyLedger.bessDischargeMWh), ...
    sum(hourlyLedger.bessThroughputMWh), ...
    sum(hourlyLedger.projectGHGKgCO2e), ...
    sum(hourlyLedger.avoidedBaselineGHGKgCO2e), ...
    sum(hourlyLedger.netGHGKgCO2e), ...
    sum(hourlyLedger.proxyProjectGHGKgCO2e), ...
    sum(hourlyLedger.proxyAvoidedGHGKgCO2e), ...
    sum(hourlyLedger.proxyNetGHGKgCO2e), ...
    all(hourlyLedger.auditPass),all(hourlyLedger.exitflag>0), ...
