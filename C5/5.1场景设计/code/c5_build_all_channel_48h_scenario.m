function scenario = c5_build_all_channel_48h_scenario()
%C5_BUILD_ALL_CHANNEL_48H_SCENARIO Build the 48 h C5 mechanism case.
%
...
[electricityPrice,electricityPriceMeta]= ...
    c5_market_price_profile('electricity_48h_mechanism',hours);
[hydrogenPrice,hydrogenPriceMeta]= ...
    c5_market_price_profile('hydrogen_48h_mechanism',hours);
[computePrice,computePriceMeta]= ...
    c5_market_price_profile('compute_48h_mechanism',hours);
...
scenario.meta=struct( ...
    ...
    'priceSourceType', ...
        ['PUBLIC_MARKET_PROXY_NOT_PROJECT_CONTRACT; ', ...
         electricityPriceMeta.scenarioId, '; ', ...
         hydrogenPriceMeta.scenarioId, '; ', ...
         computePriceMeta.scenarioId], ...
    'formulaStatus',[ ...
